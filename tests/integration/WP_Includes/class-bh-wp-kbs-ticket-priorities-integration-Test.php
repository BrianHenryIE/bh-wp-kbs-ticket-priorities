<?php
/**
 * Tests for BrianHenryIE\KBS_Ticket_Priorities main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BrianHenryIE\KBS_Ticket_Priorities_Integration_Test extends \Codeception\TestCase\WPTestCase {
